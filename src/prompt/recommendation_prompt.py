def get_behavior_analysis_prompt(actions_summary: str) -> str:
    ...
    {actions_summary}
    ---
    Provide a 2-3 sentence summary of the user's explicit intent and current topics of focus.
    """
...
def get_persuasive_recommendation_prompt(user_summary: str, product_titles: list) -> str:
    ...
    Write a short (2-3 sentences), persuasive narrative to show on the user's home feed. Explain directly to the user why these specific courses align with their recent actions and why taking action now matters for their career.
